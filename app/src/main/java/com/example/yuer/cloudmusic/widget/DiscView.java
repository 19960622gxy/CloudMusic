...
//        DISC_BG_SIZE
        LayoutParams params = (LayoutParams) iv_disc_bg.getLayoutParams();
        ...
        mVp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if(position > currentPosition){
                    //下一首
                    mDiscChangListener.onNext(position);
                }else{
                    //上一首
                    mDiscChangListener.onLast(position);
                }
        ...
        for (int i = 0; i < mPlayList.getMusics().size(); i++) {
            ...
            itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(mDiscChangListener!=null){
                        mDiscChangListener.onItemClick();
                    }
                }
            });
            ...
            LayoutParams picParams = (LayoutParams) iv_pic.getLayoutParams();
