...
import com.example.yuer.cloudmusic.adapter.HomeHeadFooterAdapter;
import com.example.yuer.cloudmusic.fragment.found.PlayListFragment;
import com.example.yuer.cloudmusic.fragment.found.RecommendedFragment;
...
//        foundItems.add(new FoundItem("主播电台", new RecommendedFragment()));
//        foundItems.add(new FoundItem("排行榜",new RecommendedFragment()));
